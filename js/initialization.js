...
function createProduct() {
    if (localStorage.getItem('products') == null) {
        ...
        },
        {
            ...
            price: 140000,
            desc: 'Những miếng há cảo, sủi cảo, hoành thánh với phần nhân tôm, sò điep, hải sản tươi ngon hay nhân thịt heo thơm ngậy chắc chắn sẽ khiến bất kỳ ai thưởng thức đều cảm thấy rất ngon miệng.'
        },
        {
            id: 39,
            status: 1,
        ...
        },
        {
            ...
            price: 70000,
            desc: 'Chả quế chay được làm từ đậu phụ và gia vị quế tự nhiên, chiên vàng giòn, thơm lừng, chấm với nước mắm chay là sự lựa chọn hoàn hảo cho bữa cơm chay.',
        },
        {
            id: 51,
            status: 1,
